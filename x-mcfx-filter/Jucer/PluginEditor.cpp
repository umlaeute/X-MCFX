    ...
    : AudioProcessorEditor (ownerFilter)
{
    ...
    addAndMakeVisible (btn_drag_lc = new ImageButton ("new button"));
    btn_drag_lc->addListener (this);

    btn_drag_lc->setImages (false, true, true,
...
void LowhighpassAudioProcessorEditor::resized()
{
    ...
    btn_drag_lc->setBounds (196, 107, 9, 10);
...
void LowhighpassAudioProcessorEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    {
        //[UserButtonCode_btn_lc_on] -- add your button handler code here..
        //[/UserButtonCode_btn_lc_on]
    }
    else if (buttonThatWasClicked == btn_lc_order)
    {
        //[UserButtonCode_btn_lc_order] -- add your button handler code here..
        //[/UserButtonCode_btn_lc_order]
    }
    else if (buttonThatWasClicked == btn_hc_on)
    {
        //[UserButtonCode_btn_hc_on] -- add your button handler code here..
        //[/UserButtonCode_btn_hc_on]
    }
    else if (buttonThatWasClicked == btn_hc_order)
    {
        //[UserButtonCode_btn_hc_order] -- add your button handler code here..
        //[/UserButtonCode_btn_hc_order]
    }
    else if (buttonThatWasClicked == btn_analyzer)
    {
        //[UserButtonCode_btn_analyzer] -- add your button handler code here..
        //[/UserButtonCode_btn_analyzer]
    }
    else if (buttonThatWasClicked == btn_drag_lc)
    {
        //[UserButtonCode_btn_drag_lc] -- add your button handler code here..
        //[/UserButtonCode_btn_drag_lc]
    }
...
void LowhighpassAudioProcessorEditor::sliderValueChanged (Slider* sliderThatWasMoved)
{
    ...
    {
        //[UserSliderCode_sld_lc_f] -- add your slider handling code here..
        //[/UserSliderCode_sld_lc_f]
    }
    else if (sliderThatWasMoved == sld_hc_f)
    {
        //[UserSliderCode_sld_hc_f] -- add your slider handling code here..
        //[/UserSliderCode_sld_hc_f]
    }
    else if (sliderThatWasMoved == sld_hs_f)
    {
        //[UserSliderCode_sld_hs_f] -- add your slider handling code here..
        //[/UserSliderCode_sld_hs_f]
    }
    else if (sliderThatWasMoved == sld_hs_g)
    {
        //[UserSliderCode_sld_hs_g] -- add your slider handling code here..
        //[/UserSliderCode_sld_hs_g]
    }
    else if (sliderThatWasMoved == sld_hs_q)
    {
        //[UserSliderCode_sld_hs_q] -- add your slider handling code here..
        //[/UserSliderCode_sld_hs_q]
    }
    else if (sliderThatWasMoved == sld_p1_f)
    {
        //[UserSliderCode_sld_p1_f] -- add your slider handling code here..
        //[/UserSliderCode_sld_p1_f]
    }
    else if (sliderThatWasMoved == sld_p1_g)
    {
        //[UserSliderCode_sld_p1_g] -- add your slider handling code here..
        //[/UserSliderCode_sld_p1_g]
    }
    else if (sliderThatWasMoved == sld_p1_q)
    {
        //[UserSliderCode_sld_p1_q] -- add your slider handling code here..
        //[/UserSliderCode_sld_p1_q]
    }
    else if (sliderThatWasMoved == sld_p2_f)
    {
        //[UserSliderCode_sld_p2_f] -- add your slider handling code here..
        //[/UserSliderCode_sld_p2_f]
    }
    else if (sliderThatWasMoved == sld_p2_g)
    {
        //[UserSliderCode_sld_p2_g] -- add your slider handling code here..
        //[/UserSliderCode_sld_p2_g]
    }
    else if (sliderThatWasMoved == sld_p2_q)
    {
        //[UserSliderCode_sld_p2_q] -- add your slider handling code here..
        //[/UserSliderCode_sld_p2_q]
    }
    else if (sliderThatWasMoved == sld_ls_f)
    {
        //[UserSliderCode_sld_ls_f] -- add your slider handling code here..
        //[/UserSliderCode_sld_ls_f]
    }
    else if (sliderThatWasMoved == sld_ls_g)
    {
        //[UserSliderCode_sld_ls_g] -- add your slider handling code here..
        //[/UserSliderCode_sld_ls_g]
    }
    else if (sliderThatWasMoved == sld_ls_q)
    {
        //[UserSliderCode_sld_ls_q] -- add your slider handling code here..
        //[/UserSliderCode_sld_ls_q]
    }
...
<JUCER_COMPONENT documentType="Component" className="LowhighpassAudioProcessorEditor"
                 componentName="" parentClasses="public AudioProcessorEditor"
                 constructorParams="LowhighpassAudioProcessor* ownerFilter" variableInitialisers="AudioProcessorEditor (ownerFilter)"
                 snapPixels="8" snapActive="0" snapShown="1" overlayOpacity="0.330"
                 fixedSize="1" initialWidth="630" initialHeight="300">
  <BACKGROUND backgroundColour="ff1a1a1a">
    <ROUNDRECT pos="209 196 95 96" cornerSize="10" fill="solid: ff424242" hasStroke="0"/>
    <ROUNDRECT pos="6 219 95 72" cornerSize="10" fill="solid: ff424242" hasStroke="0"/>
    <ROUNDRECT pos="107 195 95 96" cornerSize="10" fill="solid: ff424242" hasStroke="0"/>
    <TEXT pos="120 195 70 23" fill="solid: ffffffff" hasStroke="0" text="low shelf"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <ROUNDRECT pos="322 196 95 96" cornerSize="10" fill="solid: ff424242" hasStroke="0"/>
    <ROUNDRECT pos="423 196 95 96" cornerSize="10" fill="solid: ff424242" hasStroke="0"/>
    <ROUNDRECT pos="523 220 95 72" cornerSize="10" fill="solid: ff424242" hasStroke="0"/>
    <TEXT pos="221 194 70 23" fill="solid: ffffffff" hasStroke="0" text="peak1"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="332 194 70 23" fill="solid: ffffffff" hasStroke="0" text="peak2"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="434 195 70 23" fill="solid: ffffffff" hasStroke="0" text="high shelf"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="306 265 15 23" fill="solid: ffffffff" hasStroke="0" text="f"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="306 238 15 23" fill="solid: ffffffff" hasStroke="0" text="g"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="306 213 15 23" fill="solid: ffffffff" hasStroke="0" text="Q"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="19 218 70 23" fill="solid: ffffffff" hasStroke="0" text="low cut"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
    <TEXT pos="538 219 70 23" fill="solid: ffffffff" hasStroke="0" text="high cut"
          fontname="Default font" fontsize="15" bold="0" italic="0" justification="36"/>
  </BACKGROUND>
  <LABEL name="new label" id="b45e45d811b90270" memberName="lbl_gd" virtualName=""
         explicitFocusOrder="0" pos="0 0 115 16" textCol="ff7fffd4" edTextCol="ff000000"
         edBkgCol="0" labelText="mcfx_filter" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <IMAGEBUTTON name="new button" id="f5ce9a92153da170" memberName="btn_lc_on"
               virtualName="" explicitFocusOrder="0" pos="36 240 27 21" tooltip="low cut off"
               buttonText="new button" connectedEdges="0" needsCallback="1"
               radioGroupId="0" keepProportions="1" resourceNormal="lc_off_png"
               opacityNormal="1" colourNormal="0" resourceOver="lc_over_png"
               opacityOver="1" colourOver="0" resourceDown="lc_on_png" opacityDown="1"
               colourDown="0"/>
  <SLIDER name="new slider" id="edc665213f83e06b" memberName="sld_lc_f"
          virtualName="" explicitFocusOrder="0" pos="7 262 86 24" tooltip="low cutoff frequency"
          thumbcol="ff5a5a90" trackcol="ffff7f50" rotarysliderfill="ffff7f50"
          rotaryslideroutline="ffff7f50" min="24" max="21618" int="1" style="Rotary"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="55"
          textBoxHeight="18" skewFactor="0.55000000000000004441"/>
  <IMAGEBUTTON name="new button" id="e445621c81de1a31" memberName="btn_lc_order"
               virtualName="" explicitFocusOrder="0" pos="65 240 27 21" tooltip="2nd order low cut"
               buttonText="new button" connectedEdges="0" needsCallback="1"
               radioGroupId="0" keepProportions="1" resourceNormal="_2nd_png"
               opacityNormal="1" colourNormal="0" resourceOver="" opacityOver="1"
               colourOver="0" resourceDown="_4th_png" opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="new button" id="31d01e52cef9625b" memberName="btn_hc_on"
               virtualName="" explicitFocusOrder="0" pos="534 242 27 21" tooltip="high cut off"
               buttonText="new button" connectedEdges="0" needsCallback="1"
               radioGroupId="0" keepProportions="1" resourceNormal="hc_off_png"
               opacityNormal="1" colourNormal="0" resourceOver="hc_over_png"
               opacityOver="1" colourOver="0" resourceDown="hc_on_png" opacityDown="1"
               colourDown="0"/>
  <SLIDER name="new slider" id="58a09752fb894145" memberName="sld_hc_f"
          virtualName="" explicitFocusOrder="0" pos="535 264 86 24" tooltip="high cutoff frequency"
          thumbcol="ff5a5a90" trackcol="ffff7f50" rotarysliderfill="ffff7f50"
          rotaryslideroutline="ffff7f50" min="24" max="21618" int="1" style="Rotary"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="55"
          textBoxHeight="18" skewFactor="0.55000000000000004441"/>
  <IMAGEBUTTON name="new button" id="9f72b744e781fe02" memberName="btn_hc_order"
               virtualName="" explicitFocusOrder="0" pos="562 242 27 21" tooltip="2nd order high cut"
               buttonText="new button" connectedEdges="0" needsCallback="1"
               radioGroupId="0" keepProportions="1" resourceNormal="_2nd_png"
               opacityNormal="1" colourNormal="0" resourceOver="" opacityOver="1"
               colourOver="0" resourceDown="_4th_png" opacityDown="1" colourDown="0"/>
  <SLIDER name="new slider" id="51b3f3d7ea307da9" memberName="sld_hs_f"
          virtualName="" explicitFocusOrder="0" pos="423 264 85 24" tooltip="high shelf frequency"
          thumbcol="ff5a5a90" trackcol="ffd2691e" rotarysliderfill="ffff7f50"
          rotaryslideroutline="ffff7f50" min="24" max="21618" int="1" style="Rotary"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="55"
          textBoxHeight="18" skewFactor="0.55000000000000004441"/>
  <SLIDER name="new slider" id="8438c1de1176bbbb" memberName="sld_hs_g"
          virtualName="" explicitFocusOrder="0" pos="423 239 75 24" tooltip="high shelf gain"
          thumbcol="ff5a5a90" trackcol="ffffff00" rotarysliderfill="ffffff00"
          rotaryslideroutline="ffffff00" min="-18" max="18" int="0.10000000000000000555"
          style="Rotary" textBoxPos="TextBoxRight" textBoxEditable="1"
          textBoxWidth="45" textBoxHeight="18" skewFactor="1"/>
  <SLIDER name="new slider" id="cb37ccef9f86710d" memberName="sld_hs_q"
          virtualName="" explicitFocusOrder="0" pos="423 215 70 22" tooltip="high shelf q"
          thumbcol="ff5a5a90" trackcol="ff00ffff" rotarysliderfill="ff00ffff"
          rotaryslideroutline="ff00ffff" min="0.2000000000000000111" max="20"
          int="0.10000000000000000555" style="Rotary" textBoxPos="TextBoxRight"
          textBoxEditable="1" textBoxWidth="40" textBoxHeight="18" skewFactor="0.5"/>
  <SLIDER name="new slider" id="3fad651ae30ab6af" memberName="sld_p1_f"
          virtualName="" explicitFocusOrder="0" pos="213 264 85 24" tooltip="peak1 frequency"
          thumbcol="ff5a5a90" trackcol="ffd2691e" rotarysliderfill="ffff7f50"
          rotaryslideroutline="ffff7f50" min="24" max="21618" int="1" style="Rotary"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="55"
          textBoxHeight="18" skewFactor="0.55000000000000004441"/>
  <SLIDER name="new slider" id="ff7cfc360d281404" memberName="sld_p1_g"
          virtualName="" explicitFocusOrder="0" pos="213 239 75 24" tooltip="peak1 gain"
          thumbcol="ff5a5a90" trackcol="ffffff00" rotarysliderfill="ffffff00"
          rotaryslideroutline="ffffff00" min="-18" max="18" int="0.10000000000000000555"
          style="Rotary" textBoxPos="TextBoxRight" textBoxEditable="1"
          textBoxWidth="45" textBoxHeight="18" skewFactor="1"/>
  <SLIDER name="new slider" id="6aa4e299160e204" memberName="sld_p1_q"
          virtualName="" explicitFocusOrder="0" pos="213 215 70 22" tooltip="peak1 q"
          thumbcol="ff5a5a90" trackcol="ff00ffff" rotarysliderfill="ff00ffff"
          rotaryslideroutline="ff00ffff" min="0.2000000000000000111" max="20"
          int="0.10000000000000000555" style="Rotary" textBoxPos="TextBoxRight"
          textBoxEditable="1" textBoxWidth="40" textBoxHeight="18" skewFactor="0.5"/>
  <SLIDER name="new slider" id="6e1bc5b2a227329e" memberName="sld_p2_f"
          virtualName="" explicitFocusOrder="0" pos="324 264 85 24" tooltip="peak2 frequency"
          thumbcol="ff5a5a90" trackcol="ffd2691e" rotarysliderfill="ffff7f50"
          rotaryslideroutline="ffff7f50" min="24" max="21618" int="1" style="Rotary"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="55"
          textBoxHeight="18" skewFactor="0.55000000000000004441"/>
  <SLIDER name="new slider" id="30f35986db78e455" memberName="sld_p2_g"
          virtualName="" explicitFocusOrder="0" pos="324 239 75 24" tooltip="peak2 gain"
          thumbcol="ff5a5a90" trackcol="ffffff00" rotarysliderfill="ffffff00"
          rotaryslideroutline="ffffff00" min="-18" max="18" int="0.10000000000000000555"
          style="Rotary" textBoxPos="TextBoxRight" textBoxEditable="1"
          textBoxWidth="45" textBoxHeight="18" skewFactor="1"/>
  <SLIDER name="new slider" id="31f88a0ae88b2256" memberName="sld_p2_q"
          virtualName="" explicitFocusOrder="0" pos="324 215 70 22" tooltip="peak2 q"
          thumbcol="ff5a5a90" trackcol="ff00ffff" rotarysliderfill="ff00ffff"
          rotaryslideroutline="ff00ffff" min="0.2000000000000000111" max="20"
          int="0.10000000000000000555" style="Rotary" textBoxPos="TextBoxRight"
          textBoxEditable="1" textBoxWidth="40" textBoxHeight="18" skewFactor="0.5"/>
  <SLIDER name="new slider" id="61ed69fd8c3320f5" memberName="sld_ls_f"
          virtualName="" explicitFocusOrder="0" pos="109 266 85 24" tooltip="low shelf frequency"
          thumbcol="ff5a5a90" trackcol="ffd2691e" rotarysliderfill="ffff7f50"
          rotaryslideroutline="ffff7f50" min="24" max="21618" int="1" style="Rotary"
          textBoxPos="TextBoxRight" textBoxEditable="1" textBoxWidth="55"
          textBoxHeight="18" skewFactor="0.55000000000000004441"/>
  <SLIDER name="new slider" id="c0c8e23cb677b4a7" memberName="sld_ls_g"
          virtualName="" explicitFocusOrder="0" pos="109 241 75 24" tooltip="low shelf gain"
          thumbcol="ff5a5a90" trackcol="ffffff00" rotarysliderfill="ffffff00"
          rotaryslideroutline="ffffff00" min="-18" max="18" int="0.10000000000000000555"
          style="Rotary" textBoxPos="TextBoxRight" textBoxEditable="1"
          textBoxWidth="45" textBoxHeight="18" skewFactor="1"/>
  <SLIDER name="new slider" id="61447f92809d06fb" memberName="sld_ls_q"
          virtualName="" explicitFocusOrder="0" pos="109 217 70 22" tooltip="low shelf q"
          thumbcol="ff5a5a90" trackcol="ff00ffff" rotarysliderfill="ff00ffff"
          rotaryslideroutline="ff00ffff" min="0.2000000000000000111" max="20"
          int="0.10000000000000000555" style="Rotary" textBoxPos="TextBoxRight"
          textBoxEditable="1" textBoxWidth="40" textBoxHeight="18" skewFactor="0.5"/>
  <GENERICCOMPONENT name="new component" id="885d5198e7f04ca3" memberName="filtergraph"
                    virtualName="" explicitFocusOrder="0" pos="26 21 580 170" class="Component"
                    params=""/>
  <IMAGEBUTTON name="new button" id="a9a912c78f80c56a" memberName="btn_analyzer"
               virtualName="" explicitFocusOrder="0" pos="27 193 58 20" buttonText="new button"
               connectedEdges="0" needsCallback="1" radioGroupId="0" keepProportions="1"
               resourceNormal="analyzer_off_png" opacityNormal="1" colourNormal="0"
               resourceOver="analyzer_over_png" opacityOver="1" colourOver="0"
               resourceDown="analyzer_on_png" opacityDown="1" colourDown="0"/>
  <IMAGEBUTTON name="new button" id="40d434b127505653" memberName="btn_drag_lc"
               virtualName="" explicitFocusOrder="0" pos="196 107 9 10" buttonText="new button"
               connectedEdges="0" needsCallback="1" radioGroupId="0" keepProportions="1"
...
static const unsigned char resource_LowhighpassAudioProcessorEditor_drag_off_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,31,0,0,0,31,8,6,0,0,1,104,169,38,175,0,0,0,9,112,72,89,115,0,
...
const char* LowhighpassAudioProcessorEditor::drag_off_png = (const char*) resource_LowhighpassAudioProcessorEditor_drag_off_png;
const int LowhighpassAudioProcessorEditor::drag_off_pngSize = 903;

// JUCER_RESOURCE: drag_on_png, 1172, "drag_on.png"
static const unsigned char resource_LowhighpassAudioProcessorEditor_drag_on_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,31,0,0,0,31,8,6,0,0,1,104,169,38,175,0,0,0,9,112,72,89,115,0,0,
...
const char* LowhighpassAudioProcessorEditor::drag_on_png = (const char*) resource_LowhighpassAudioProcessorEditor_drag_on_png;
const int LowhighpassAudioProcessorEditor::drag_on_pngSize = 1172;

// JUCER_RESOURCE: drag_over_png, 693, "drag_over.png"
static const unsigned char resource_LowhighpassAudioProcessorEditor_drag_over_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,31,0,0,0,31,8,6,0,0,1,104,169,38,175,0,0,0,9,112,72,89,115,0,
...
const char* LowhighpassAudioProcessorEditor::drag_over_png = (const char*) resource_LowhighpassAudioProcessorEditor_drag_over_png;
const int LowhighpassAudioProcessorEditor::drag_over_pngSize = 693;
